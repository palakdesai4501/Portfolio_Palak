...
function Projects({}: Props) {
  ...
  return (
    <motion.div 
        ...
        <div className='relative w-full flex overflow-x-scroll space-y-5 overflow-hidden snap-x snap-mandatory z-20 mt-40'>
           {projects.map((project, i) => (
            <div className='w-screen flex-shrink-0 snap-center flex flex-col   items-center justify-center p-20 md:p-44 h-screen '>
                <motion.img 
                    ...
                    viewport={{ once: true}}
                    src="/yt.png" alt="youtube-clone" className='xl:size-96 sm: size-60' />
