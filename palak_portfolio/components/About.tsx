...
export default function About({}: Props) {
  return (
    ...
    className="flex flex-col relative h-screen top-24 text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl pl-16">
        About
      </h3>
